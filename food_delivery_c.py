# -*- coding: utf-8 -*-
"""FOOD_DELIVERY_C.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PYFsGbwif02-Yvrof7WqmaoDv8DFzOE4
"""
...
# for c in ['Customer_Gender','City','Area','Cuisine_Type','Payment_Mode','Order_Status','Cancellation_Reason']:
#   print('\ncolum:',c)
#   print(data[c].value_counts().head())
#   print('Unique values',data[c].unique())
#   print("Missing:", data[c].isna().sum())
